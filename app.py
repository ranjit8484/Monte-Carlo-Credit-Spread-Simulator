...
num_simulations = st.sidebar.number_input("Number of Simulations", min_value=1, max_value=1000, value=5)
...
for sim in range(num_simulations):
    ...
    all_account_histories.append(account_history)
...
for i in range(min(num_simulations, 10)):  # plot up to 10 simulations
    ax2.plot(range(len(all_account_histories[i])), all_account_histories[i], alpha=0.7)
